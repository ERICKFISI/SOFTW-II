            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Compras <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-desktop"></i> Seguridad <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="visualizar_usuario.php">Visualizar usuario</a></li>
                      <li><a href="form_validation.php">Registrar usuario</a></li>
                    </ul>
                  </li>
