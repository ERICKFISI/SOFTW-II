...
<html lang="es">
    <head>
        ...
        <link href="<?php echo base_url() . "/public/vendors/select2/dist/css/select2.min.css" ?>" rel="stylesheet">
...
<!-- Bootstrap -->
        ...
        <script src="<?php echo base_url() . "/public/vendors/select2/dist/js/select2.min.js" ?>"></script>
