<div class="">
    <div class="title">
        <div class="col-12">
            <h3>Visualizar Ingreso</small></h3>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel ">
                <div class="x_title">
                    <a href="<?= base_url() . "/home/registraringreso"; ?>" class="btn btn-success">Registrar Ingreso</a>
                    <a href="<?= base_url() . "/visualizarsalida"; ?>" class="btn btn-info">Visualizar Salida</a>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div class="row">
